            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <img alt="image" src="{{ asset('admintemplate/') }}/img/avatar/avatar-1.png" class="rounded-circle mr-1">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <img src="/frontemplate/img/logo.png" alt="logo" class="w-50 mb-5">
                        {{-- <a href="{{ route('admin') }}">Elearning</a> --}}
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="{{ route('admin') }}"><img src="/frontemplate/img/logo.png" alt="logo" class="w-100"></a>
                    </div>
                    <ul class="sidebar-menu">
                        <li class="menu-header mt-2">Menu Administrator</li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="{{ route('admin.transaksi.belumdicek') }}">Diproses</a>
                                </li>
